...
public class SicsSUSEP {
	...
	public SicsSUSEP(String susep, String sucursal, String dataDebito, String valorServico) {
		this.susep = susep;
	...
	public String toString() {
		return empresa + "|" + tipoLanctoComl + "|" + trioContabil
				+ "|" + tipoHistComissao + "|" + susep + "|" + sucursal + "|"
				+ ramo + "|" + origemProposta + "|" + proposta + "|" + parcela
				+ "|" + dataDebito + "|" + valorServico;
	}
